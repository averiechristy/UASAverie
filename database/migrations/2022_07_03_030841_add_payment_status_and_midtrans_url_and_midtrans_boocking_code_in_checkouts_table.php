...
class AddPaymentStatusAndMidtransUrlAndMidtransBoockingCodeInCheckoutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('checkouts', function (Blueprint $table) {
            $table->string('payment_status', 100)->default('waiting')->after('products_id');
